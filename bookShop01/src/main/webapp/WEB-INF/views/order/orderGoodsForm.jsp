...
<form  name="form_order">	
   ...
   <div class="clear"></div>
	...
	<center>
		...
		<img width="125" alt="" src="${contextPath}/resources/image/btn_gulje.jpg"> <!-- 결제하기 --> 
		</a> <a href="${contextPath}/main/main.do"> 
		   <img width="75" alt="" src="${contextPath}/resources/image/btn_shoping_continue.jpg"> <!-- 쇼핑 계속 하기 -->
		</a>
